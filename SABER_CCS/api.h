...
int crypto_kem_enc(unsigned char *ct, unsigned char *ss, const unsigned char *pk, unsigned char *pt);
int crypto_kem_dec(unsigned char *ss, const unsigned char *ct, const unsigned char *sk, unsigned char *pt);
